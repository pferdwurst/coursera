...
class Classes extends ListNode {
	...
	public List<AbstractSymbol> getNames() {
		return null;
	}
	...
	public boolean contains(AbstractSymbol class_name) {
		...
		for (Enumeration e = getElements(); e.hasMoreElements();) {
			...
			if (c.name.equalString(class_name.str, class_name.str.length())) {
				return true;
			}
		} 
		return false;
	...
	public void accept(Visitor visitor) {
		for (Enumeration<Visitable> e = this.getElements(); e.hasMoreElements();) {
			visitor.visit((class_c) e.nextElement());
		}
	}
}
...
class Features extends ListNode {
	...
	public void accept(Visitor visitor) {
		...
		Enumeration<Visitable> e = this.getElements(); e.hasMoreElements();) {
			visitor.visit((Feature) e.nextElement());
		}
	}
}
...
class Formals extends ListNode {
	...
	public void accept(Visitor visitor) {
		for (@SuppressWarnings("unchecked")
		Enumeration<Visitable> e = this.getElements(); e.hasMoreElements();) {
			visitor.visit((Formal) e.nextElement());
		}
	}
}
...
class Expressions extends ListNode {
	...
	/** Creates an empty "Expresbrsions" list */
	...
	public void accept(Visitor visitor) {
		for (@SuppressWarnings("unchecked")
		Enumeration<Visitable> e = this.getElements(); e.hasMoreElements();) {
			visitor.visit((Expression) e.nextElement());
		}
	}
}
...
class Cases extends ListNode {
	...
	public void accept(Visitor visitor) {
		for (@SuppressWarnings("unchecked")
		Enumeration<Visitable> e = this.getElements(); e.hasMoreElements();) {
			visitor.visit((typcase) e.nextElement());
		}
	}
}
...
class programc extends Program {
	 ...
	 * Part (2) can be done in a seccond stage when you want to test the
	 * complete compiler.
	 */
	public void semant() {
		...
		TypeChecker typer = new TypeChecker(classTable);

		for (Enumeration e = classes.getElements(); e.hasMoreElements();) {
			Visitable n = (Visitable) e.nextElement();
			n.accept(typer);
		}
